...
function RewriteFromStorage () {
	...
	while (k >= 1) {
		...
		btn.onclick = function () {
			...
			if (confirm("Once deleted, cannot be recovered")) {
				...
				$("notes").innerHTML = '<div id=\"1\" style=\"height:370px;padding:10px 15px 10px 15px;overflow-y:auto;\"><h2>Enjoy a simple, fast and elegant way of making notes in your browser</h2><span style="position:absolute;bottom:110px;left:63px;">Developed by <a href="http://aniruddhanath.com" target="_blank">Aniruddha Nath</a></em></span>';
				RewriteFromStorage();
			}
			else {
	...
	if (localStorage.length==0) {
		document.getElementById('list').innerHTML = "<h2 style=\"margin:0px;\">Hi There...</h2><p>You don't have any notes now.</p><p>Start by typing your notes (on the right pane) after clicking <em>Add New</em> button</p><p>Happy note-making.</p>";
	}
